...
public class LibraryController {
    ...
    public NonEditableModel searchBookByName(String name){
        NonEditableModel searchModel = new NonEditableModel(new Object[]{"고유번호", "도서명", "저자", "출판사"}, 0);
    ...
    public int request(String book, String author, String publisher) {
        ...
        //도서명에 입력된 항목이 존재하지 않는다면 0, 이미 있다면 1
